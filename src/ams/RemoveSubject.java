...
public class RemoveSubject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Remove Subject");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            conn c=new conn();
            c.stmt.executeUpdate("delete from attendance where s_code='"+jTextField1.getText()+"'");
            c.stmt.executeUpdate("delete from subject where s_code='"+jTextField1.getText()+"'");
        }
