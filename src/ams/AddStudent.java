...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            conn c=new conn();
            c.stmt.executeUpdate("insert into student values ('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+(String)jComboBox1.getSelectedItem()+"',"+(String)jComboBox2.getSelectedItem()+")");
        }
