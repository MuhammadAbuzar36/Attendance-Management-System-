...
public class AddTeacher extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            c.stmt.executeUpdate("insert into teacher values ("+jTextField1.getText()+",'"+jTextField7.getText()+"','"+s+"','"+jTextField2.getText()+"','"+(String)jComboBox1.getSelectedItem()+"',"+(String)jComboBox2.getSelectedItem()+")");
        }
