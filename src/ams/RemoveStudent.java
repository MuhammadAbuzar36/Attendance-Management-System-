...
public class RemoveStudent extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            conn c=new conn();
            c.stmt.executeUpdate("delete from attendance where roll_no='"+jTextField1.getText()+"'");
            c.stmt.executeUpdate("delete from student where roll_no='"+jTextField1.getText()+"'");
        }
