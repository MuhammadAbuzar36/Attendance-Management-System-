...
public class EditAttendance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Edit Attendance");
        ...
        try{
            conn c=new conn();
            ResultSet rs=c.stmt.executeQuery("select * from  subject");
            while(rs.next()){
                a[i++]=rs.getString(1);
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(a>0 && a<46){
            try{
                conn c=new conn();
                c.stmt.executeUpdate("update attendance set taken="+a+"where roll_no='"+jTextField1.getText()+"' AND s_code='"+(String)jComboBox1.getSelectedItem()+"'");
            }catch(Exception e){}
        }   
